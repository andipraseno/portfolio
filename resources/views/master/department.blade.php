            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-header d-flex align-items-center">
                        <h5 class="card-title mb-0 flex-grow-1">Daftar Department</h5>
                        <div>
                            <a href="{{ url('/master/department_add') }}" id="addRow" class="btn btn-primary">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#dgvList').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": "{{ url('/master/department_list') }}",
                    "type": "POST",
                    data: function(d) {
                        d._token = "{{ csrf_token() }}";
                    }
                        ...
                        render: function(data, type, row, meta) {
                            return `<div class="dropdown d-inline-block">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a href="{{ url('/master/department_edit') }}/` + row['id'] + `"
                                                    class="dropdown-item edit-item-btn">
                                                    <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit
                                                </a>
                                            </li>
                                            <li>
                                                <a href="{{ url('/master/department_terminate') }}/` + row['id'] + `"
