            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="text-center mt-2">
                        <h5 class="text-primary">Input Karyawan</h5>
                    </div>
                    ...
                    <div class="p-2 mt-4">
                        <form action="{{ url('/master/karyawan_add_save') }}" method="post">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                    id="txtKode" name="kode" placeholder="Kode" value="{{ old('kode') }}" required
                                    autocomplete="off">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control @error('pin') is-invalid @enderror"
                                    id="txtPIN" name="pin" placeholder="PIN" value="{{ old('pin') }}" required
                                    autocomplete="off">
                                ...
                                <select class="js-example-basic-single" id="cboDepartment" name="department">
                                    @foreach ($department as $res_department)
                                        <option value="{{ $res_department->id }}"
                                            {{ old('department') == $res_department->id ? 'selected' : '' }}>
                                ...
                                <select class="js-example-basic-single" id="cboJabatan" name="jabatan">
                                    @foreach ($jabatan as $res_jabatan)
                                        <option value="{{ $res_jabatan->id }}"
                                            {{ old('jabatan') == $res_jabatan->id ? 'selected' : '' }}>
