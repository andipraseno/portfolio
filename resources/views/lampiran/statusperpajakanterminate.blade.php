            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ url('/lampiran/statusperpajakan') }}">Status Perpajakan</a>
                        </li>
            ...
            <div class="card mt-4">
                <div class="card-body p-4">
                    <div class="text-center mt-2">
                        <h5 class="text-primary">Terminate Status Perpajakan</h5>
                    </div>
                    ...
                    <div class="p-2 mt-4">
                        <form action="{{ url('/lampiran/statusperpajakan_terminate_save') }}" method="post">
                            @csrf
